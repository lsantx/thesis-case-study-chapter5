...
% numero de ciclos que ser�o avaliados
% limite da ordem harmonica que deseja-se usar
% inicio do ciclo (come�a do 0)

ni=size(0:passo:inicio/fn); % posi�ao no vetor para inicio da analise
nf=size(0:passo:(inicio/fn+ciclos/fn)); % posi�ao no vetor para fim da analise
