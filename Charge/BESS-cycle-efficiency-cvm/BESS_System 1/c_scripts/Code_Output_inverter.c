...
Ialfabeta.alfa = (PLL.Valfa_in*(-(I_char+(I_char+Ibat))*Vdc) + Qref*PLL.Vbeta_in)/(PLL.Valfa_in*PLL.Valfa_in + PLL.Vbeta_in*PLL.Vbeta_in + 1e-2);
Ialfabeta.beta = (PLL.Vbeta_in*(-(I_char+(I_char+Ibat))*Vdc) - Qref*PLL.Valfa_in)/(PLL.Valfa_in*PLL.Valfa_in + PLL.Vbeta_in*PLL.Vbeta_in + 1e-2);
