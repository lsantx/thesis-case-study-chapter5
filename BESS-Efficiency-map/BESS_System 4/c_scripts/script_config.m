...
Pnom = 100e3;
PVals = [Pnom Pnom*0.9 Pnom*0.8 Pnom*0.7 Pnom*0.6 Pnom*0.5 Pnom*0.4 Pnom*0.3 Pnom*0.2];
...
for ki = 1:length(PVals)
    for kj = 1:length(SocVals)
        ...
        Pot_bat2(ki,kj) = Out.Values(16,end);
        Pchaves_conv_cc_cond2(ki,kj) = Out.Values(17,end);
        Pchaves_conv_cc_sw2(ki,kj) = Out.Values(18,end);
        Bind2(i,:) = Out.Values(19,(end-(2/(60)/(1/(12000*120))):end));
        Pcp_ind_bt2(ki,kj) = Out.Values(20,end);
        Ibat2(ki,kj) = Out.Values(21,end);
        Vbat2(ki,kj) = Out.Values(22,end);
        i = i + 1;
    end    
end
